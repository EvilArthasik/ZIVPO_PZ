...
[[nodiscard]] bool ConfirmStopInActiveSession()
{
    ...
    const BOOL sent = WTSSendMessageW(
        ...
        const_cast<LPWSTR>(L"Stop Windows service and close all application instances?"),
        static_cast<DWORD>(sizeof(L"Stop Windows service and close all application instances?")),
