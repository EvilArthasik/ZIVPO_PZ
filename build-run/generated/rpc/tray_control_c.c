...
static const RPC_CLIENT_INTERFACE TrayControl___RpcClientInterface =
    {
...
RPC_IF_HANDLE TrayControl_v1_0_c_ifspec = (RPC_IF_HANDLE)& TrayControl___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE TrayControl__MIDL_AutoBindHandle;
    ...
    /* [in] */ handle_t binding)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[0],
                  binding);
    ...
    /* [out] */ TrayAuthState *state)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[30],
                  binding,
                  state);
    ...
    /* [out] */ TrayAuthState *state)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[72],
                  binding,
                  username,
                  password,
                  state);
    ...
    /* [in] */ handle_t binding)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[126],
                  binding);
    ...
    /* [out] */ TrayLicenseState *state)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[156],
                  binding,
                  state);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [out] */ TrayLicenseState *state)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[198],
                  binding,
                  licenseKey,
                  state);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [in] */ handle_t binding)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[246],
                  binding);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [out] */ TrayAvDatabaseInfo *info)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[282],
                  binding,
                  info);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [out] */ TrayScanReport *report)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[324],
                  binding,
                  path,
                  report);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [out] */ TrayScanReport *report)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[372],
                  binding,
                  path,
                  report);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [out] */ TrayScanReport *report)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[420],
                  binding,
                  report);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [in] */ unsigned long intervalMinutes)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[462],
                  binding,
                  intervalMinutes);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [out] */ TrayScanReport *report)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[504],
                  binding,
                  report);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [string][in] */ wchar_t *path)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[546],
                  binding,
                  path);
    return ( unsigned long  )_RetVal.Simple;
    ...
    /* [out] */ TrayScanReport *report)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&TrayControl_StubDesc,
                  (PFORMAT_STRING) &tray_control__MIDL_ProcFormatString.Format[588],
                  binding,
                  report);
    return ( unsigned long  )_RetVal.Simple;
...
static const MIDL_STUB_DESC TrayControl_StubDesc = 
    {
    (void *)& TrayControl___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &TrayControl__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
